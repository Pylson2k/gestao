    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === 'left' &&
            'data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left inset-y-0 left-0 h-full w-[min(100vw-0.75rem,26rem)] overflow-y-auto border-r sm:max-w-md',
          side === 'top' &&
...
function SheetFooter({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('mt-auto flex min-w-0 flex-col gap-2 p-4 sm:flex-row sm:justify-end', className)}
      {...props}
    />
  )
}

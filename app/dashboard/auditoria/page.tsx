...
const actionLabels: Record<string, string> = {
  ...
  download_service_order_pdf: 'PDF ordem de serviço',
...
const actionColors: Record<string, string> = {
  ...
  download_service_order_pdf: 'bg-indigo-500/10 text-indigo-500 border-indigo-500/20',
...
const actionIcons: Record<string, any> = {
  ...
  download_service_order_pdf: CheckCircle,
